...
TAG_PADDING = 2
TAG_CLOUD_PADDING = 2 # Margins added to the whole image
...
def _archimedean_spiral(reverse):
    ...
    while True:
        ...
        #t += DEFAULT_STEP * STEP_SIZE * r / (RADIUS * (t + DEFAULT_STEP * STEP_SIZE))
...
def create_tag_image(
    ...
    #data = pygame.image.tostring(image_surface,"RGB")
    #return data
